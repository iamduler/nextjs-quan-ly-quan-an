                ...
                render={({ field }) => (
                  <FormItem>
                    <div className='grid gap-3'>
                      ...
                      <Input id='oldPassword' type='password' className='w-full' autoComplete='current-password' {...field} />
                      <FormMessage />
                    </div>
                  </FormItem>
                )}
                ...
                render={({ field }) => (
                  <FormItem>
                    <div className='grid gap-3'>
                      ...
                      <Input id='confirmPassword' type='password' className='w-full' autoComplete='new-password' {...field} />
                      <FormMessage />
                    </div>
                  </FormItem>
                )}
