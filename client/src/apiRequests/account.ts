...
const accountApiRequest = {
	...
	add: (body: CreateEmployeeAccountBodyType) => http.post<AccountResType>(`${prefix}`, body),
	update: (id: number, body: UpdateEmployeeAccountBodyType) => http.put<AccountResType>(`${prefix}/detail/${id}`, body),
	delete: (id: number) => http.delete<AccountResType>(`${prefix}/detail/${id}`),
	get: (id: number) => http.get<AccountResType>(`${prefix}/detail/${id}`),
}
